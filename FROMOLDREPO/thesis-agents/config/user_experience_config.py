...
class UserExperienceConfig:
    ...
    MAX_RESPONSE_LENGTH = 1200  # increased from 600 for better completeness
    MAX_COGNITIVE_INTERVENTION_LENGTH = 400  # increased from 250
    MAX_SOCRATIC_RESPONSE_LENGTH = 400  # increased from 250
    MAX_DOMAIN_EXPERT_RESPONSE_LENGTH = 600  # increased from 400
